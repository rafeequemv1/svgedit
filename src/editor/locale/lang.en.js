export default {
  ...
  ui: {
    ...
    zoom_level: 'Change zoom level (Ctrl/Cmd + scroll zooms toward cursor)',
    panel: 'Panel',
    ...
    prop_section_character: 'Character',
    prop_section_paragraph: 'Paragraph',
    prop_section_spacing: 'Spacing',
    prop_section_style: 'Style',
    prop_section_path: 'Path',
    prop_section_group: 'Group',
    prop_section_link: 'Link',
    prop_section_identity: 'Identity',
    prop_section_image: 'Image',
    prop_section_line: 'Line',
    prop_section_pencil: 'Pencil',
    prop_section_align: 'Align',
    prop_text_placeholder: 'Text content',
    quality: 'Quality:',
  ...
  properties: {
    ...
    freehand_smoothing: 'Smoothing',
    freehand_smoothing_title: 'How much to simplify freehand strokes (0 = follow the stroke, 100 = very smooth)',
